(() => {
  ...
  // Startup headphone warning. Clicking OK hides it and reveals the main menu behind it.
  if (ui.headphoneOkBtn && ui.headphoneWarning) {
    ui.headphoneOkBtn.addEventListener("click", () => {
      ui.headphoneWarning.classList.add("hidden");
      if (ui.startScreen) ui.startScreen.classList.remove("hidden");
    });
  }
